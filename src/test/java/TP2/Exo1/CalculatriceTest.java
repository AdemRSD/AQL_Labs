...
public class CalculatriceTest {
    ...
    public void testAdditionner() {
        ...
        // Note : La classe Calculatrice n'a pas de méthode getState(), et l'état interne
        // (variable result) n'est pas accessible. De plus, comme nous utilisons un mock,
        // l'état interne n'est pas pertinent. Ce TODO semble être une erreur dans le document.
